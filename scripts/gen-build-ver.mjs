...
const buildAssets = {
  css: [...foundationCss, luxeCss, hubCss, patchCss, proSuiteCss, '/assets/css/global.unify.v4.20260313.css'].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/css/${f}`),
  js: [...foundationJs, globalJs, searchTypingJs, proSuiteJs, '/assets/js/global.unify.v3.20260313.js'].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/js/${f}`),
};
