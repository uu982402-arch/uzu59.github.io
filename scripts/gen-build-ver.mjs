...
const buildAssets = {
  css: [...foundationCss, luxeCss, hubCss, patchCss, proSuiteCss, '/assets/css/global.unify.v4.20260313.css', '/assets/css/site.mode.v18.20260313.css', '/assets/css/site.compact.v19.20260313.css', '/assets/css/home.simplify.v20.20260313.css', '/assets/css/site.sweep.v21.20260313.css', '/assets/css/site.finish.v25.20260313.css'].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/css/${f}`),
  js: [...foundationJs, globalJs, searchTypingJs, proSuiteJs, '/assets/js/global.unify.v3.20260313.js', '/assets/js/site.sweep.v21.20260313.js', '/assets/js/site.finish.v25.20260313.js'].filter(Boolean).map((f) => f.startsWith('/assets/') ? f : `/assets/js/${f}`),
};
